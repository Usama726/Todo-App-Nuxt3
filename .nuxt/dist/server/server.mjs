import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, isRef, isReactive, watch, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, resolveComponent, isShallow, Suspense, mergeProps, Transition, withCtx, createTextVNode, toDisplayString, useSSRContext, createVNode, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/About-DkoGDbet.js").then((m) => m.default || m)
  },
  {
    name: "HomePage",
    path: "/HomePage",
    ...
    component: () => import("./_nuxt/HomePage-Br5bMXte.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-BRwbCtYS.js").then((m) => m.default || m)
  },
  {
    name: "task",
    path: "/task",
    ...
    component: () => import("./_nuxt/task-LEsjPGeI.js").then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    component: () => import("./_nuxt/test-B5aGIx8R.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CM-CWD6f.js").then((r) => r.default || r));
