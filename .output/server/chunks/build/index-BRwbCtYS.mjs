...
import HomePage from './HomePage-Br5bMXte.mjs';
import './server.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Body, mergeProps({ class: "bg-secondary h-screen overflow-hidden fixed top-0 w-full px-4" }, _attrs), {
...
//# sourceMappingURL=index-BRwbCtYS.mjs.map
